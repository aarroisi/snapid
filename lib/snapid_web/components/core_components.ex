defmodule SnapidWeb.CoreComponents do
  @moduledoc """
  ...
  attr :actions_class, :string, default: "flex items-center justify-between gap-4"
  attr :top_actions_class, :string, default: "flex items-center justify-between gap-4"
  ...
  slot :inner_block, required: true
  slot :top_actions, doc: "the slot for form actions, such as a submit button, placed at top"
  ...
  attr :is_show_error, :boolean, default: true
  ...
  def input(%{field: %Phoenix.HTML.FormField{} = field} = assigns) do
    errors = if assigns.is_show_error, do: Enum.map(field.errors, &translate_error(&1)), else: []
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SnapidWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SnapidWeb.Gettext, "errors", msg, opts)
    end
  end
